...
const MomCareHomeScreen = () => {
  ...
  const carouselItems = [
    { image: './assets/backgroud.png', title: 'Healthy Baby Tips' },
    { image: './assets/backgroud.png', title: 'Caracal Fun Facts' },
    { image: './assets/backgroud.png', title: 'Outdoor Activities' },
  ];
